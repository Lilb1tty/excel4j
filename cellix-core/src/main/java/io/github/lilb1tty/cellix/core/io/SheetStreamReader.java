...
public final class SheetStreamReader implements AutoCloseable {
    ...
    public Stream<Row> stream() {
        try {
            ...
            throw new CellixReadException("Failed to stream sheet", e);
        }
    }
    ...
    private static final class RowIterator implements Iterator<Row> {
         ...
         *   - sheets WITHOUT &lt;row&gt; elements (cellix writer omits them)
         */
        private void fillBuffer() {
            ...
            try {
                ...
                throw new CellixReadException("Error reading sheet XML", e);
            }
        }
